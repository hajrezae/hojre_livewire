                    ...
                    <div class="text-left flex-grow-1">
                        ...
                        <div class="dropdown dropdown-inline">
                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{ Metronic::getSVG("admin/media/svg/icons/Communication/Add-user.svg", "svg-icon-lg") }}
                            </button>
                    ...
                    <div class="scroll scroll-pull" data-height="400" data-mobile-height="350">
                        ...
                        <div class="messages">
                            ...
                            <div class="d-flex flex-column mb-5 align-items-start">
                                ...
                                <div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold text-left max-w-400px">
                                    You can unwatch this repository imadmin/mediately by clicking here: <a href="#">https://github.com</a>
                                </div>
                            </div>
