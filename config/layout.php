...
return [
    ...
    'resources' => [
        ...
        'css' => [
            'admin/plugins/global/plugins.bundle.css',
            'admin/plugins/custom/prismjs/prismjs.bundle.css',
            'admin/css/style.bundle.css',
        ],
        'js' => [
            'admin/plugins/global/plugins.bundle.js',
            'admin/plugins/custom/prismjs/prismjs.bundle.js',
            'admin/js/scripts.bundle.js',
        ],
    ],
